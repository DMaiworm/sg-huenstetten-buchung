...
interface BookingEditModalProps {
  booking: (Booking & { seriesBookings?: Booking[] }) | null;
  open: boolean;
  onClose: () => void;
  onSave: (id: string, updates: Record<string, string>) => Promise<{ error?: string | null } | undefined>;
}
...
const BookingEditModal: React.FC<BookingEditModalProps> = ({ booking, open, onClose, onSave }) => {
  ...
  const statusLabel = ({ approved: 'Genehmigt', pending: 'Ausstehend', rejected: 'Abgelehnt' } as Record<string, string>)[booking.status] || booking.status;
  const statusCls = ({ approved: 'bg-green-100 text-green-800', pending: 'bg-yellow-100 text-yellow-800', rejected: 'bg-red-100 text-red-800' } as Record<string, string>)[booking.status] || 'bg-gray-100 text-gray-800';
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="date" value={seriesEndDate} readOnly
