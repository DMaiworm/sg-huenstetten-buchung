/**
 * TeamOverviewCard – Übersichtskarte für eine Mannschaft.
 *
 * Zeigt: Teamname, Trainer, Trainingszeiten/-orte, nächster Termin.
 */
...
const TeamOverviewCard = ({ team, trainerAssignments, users, resources, trainings, nextEvent }) => {

  // ── Trainer für dieses Team ──
  ...
  // ── Trainingszeiten: Serien deduplizieren ──
  ...
  // ── Nächster Termin: Ressource + Event-Typ ──
