...
const HolidayFormModal = ({ open, onClose, onSave, holiday }) => {
  ...
  // Auto-sync endDate when startDate changes and type is feiertag
  const handleStartDateChange = (val) => {
    const update = { ...form, startDate: val };
