...
function stammvereinSelectValue(user: UserFormData): string {
...
const UserFormModal: React.FC<UserFormModalProps> = ({ newUser, setNewUser, editingUser, saving, onSubmit, onClose, clubs = [] }) => {
          ...
          <div className="px-6 py-5 space-y-3.5">
            ...
            {!PERMISSIONS.some(p => newUser[p.key]) && (
              <div className="px-3.5 py-2.5 bg-yellow-50 rounded-lg text-sm text-yellow-800">
                Ohne Berechtigungen kann diese Person sich zwar einloggen, aber nichts tun.
              </div>
            )}
