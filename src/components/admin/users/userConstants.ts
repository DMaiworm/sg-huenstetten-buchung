import { UserX, Clock, CheckCircle, type LucideIcon } from 'lucide-react';
...
export const emptyUser = {
  ...
  stammvereinId: null as string | null, stammvereinAndere: null as string | null,
};
...
export function trainerStatus(user: UserLike): 'aktiv' | 'eingeladen' | 'passiv' | null {
