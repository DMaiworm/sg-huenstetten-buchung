...
import type { Team, TrainerAssignment, User } from '../../../types';
...
interface TeamCardProps {
  ...
  onDeleteTeam: () => void;
  onAddTrainer: (teamId: string, userId: string) => void;
  onUpdateAssignment: (assignment: TrainerAssignment) => void;
  onRemoveTrainer: (id: string) => void;
}

const TeamCard: React.FC<TeamCardProps> = ({ team, users, trainerAssignments, onUpdateTeam, onDeleteTeam, onAddTrainer, onUpdateAssignment, onRemoveTrainer }) => {
