...
import type { Department, Team, TrainerAssignment, User } from '../../../types';
...
const DepartmentSection: React.FC<DepartmentSectionProps> = ({ department, teams, users, trainerAssignments,
