...
function formatYear(str: string | null): string | null {
  return str ? str.split('-')[0] : null;
}

function MehrHinweis({ count }: { count: number }) {
...
interface TrainerUebersichtCardProps {
  trainer: TrainerUebersichtEntry;
  trainerAssignments: TrainerAssignment[];
  teams: Team[];
  departments: Department[];
  clubs: Club[];
  onDetail: (trainer: TrainerUebersichtEntry) => void;
}

const TrainerUebersichtCard: React.FC<TrainerUebersichtCardProps> = ({ trainer, trainerAssignments, teams, departments, clubs, onDetail }) => {
